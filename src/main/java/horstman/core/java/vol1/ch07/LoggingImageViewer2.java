...
public class LoggingImageViewer2 {
    public static void main(String[] args) {
        ...
        {
            var windowHandler = new WindowHandler2();
            windowHandler.setLevel(Level.ALL);
            Logger.getLogger("com.horstmann.corejava").addHandler(windowHandler);

            var frame = new ImageViewerFrame2();
...
class ImageViewerFrame2 extends JFrame {
    ...
    private class FileOpenListener implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            int r = chooser.showOpenDialog(ImageViewerFrame2.this);
 ...
 */
class WindowHandler2 extends StreamHandler {
    private JFrame frame;

    public WindowHandler2() {
        frame = new JFrame();
